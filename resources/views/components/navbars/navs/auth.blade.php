        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav  justify-content-end">
                ...
                <li class="nav-item pe-3 d-flex align-items-center">
                    <a href="javascript:;" class="nav-link text-body p-0" id="openEmailForm">
                        <i class="fa fa-question fixed-plugin-button-nav cursor-pointer"></i>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Your email form content goes here -->
                <!-- Example: -->
                <form>
                    <div class="mb-3">
